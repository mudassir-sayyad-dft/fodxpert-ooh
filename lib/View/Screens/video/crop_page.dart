            ...
            Padding(
              ...
              child: Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
                Expanded(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                        color: GetColors.primary.withValues(alpha: 0.2),
                        shape: BoxShape.circle),
                    child: IconButton(
                      onPressed: () => Navigator.pop(context),
                      icon: const Center(
                        child: Icon(Icons.close, color: GetColors.primary),
                      ),
                    ),
                  ),
                ),
                ...
                Expanded(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                        color: GetColors.green.withValues(alpha: 0.2),
                        shape: BoxShape.circle),
                    child: IconButton(
                      onPressed: () {
                        try {
                          print("Current crop: ${controller.cacheMaxCrop}");
                          print("Current crop: ${controller.cacheMinCrop}");
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                                content: Text(
                                    "Crop failed. Please choose a different crop area.")),
                          );
                        }
                      },
                      icon: const Center(
                        child: Icon(Icons.check, color: GetColors.green),
                      ),
                      // Center(
                      //   child: Text(
                      //     "done",
